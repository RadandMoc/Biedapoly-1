...
namespace Biedapoly
{
    ...
    public class Map
    {
        ...
        public Map(string mapName, Dictionary<string, Territory> dictionaryOfTerritories, Dictionary<int, int> defaultMoney, Dictionary<int, Card> prospect, Dictionary<int, Card> socialTreasury, Dictionary<int, int> moneyForPrison, Dictionary<Territory, int> alliance, Dictionary<int,int> moneyForStart, Dictionary<int, int> dictionaryOfRings, string prisonCoordinates, string prisonVisiterCoordinates, Player bank, string startCoordinates)
        {
            MapName = mapName;
